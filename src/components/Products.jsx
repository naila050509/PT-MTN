...
import { Laptop, PenTool, ShieldAlert, Armchair, ChevronRight, CheckCircle2 } from 'lucide-react';
...
export default function Products() {
  ...
  const categories = [
    ...
    { id: 'it', name: 'IT & Komputer', icon: <Laptop size={16} /> },
    { id: 'atk', name: 'Alat Tulis Kantor', icon: <PenTool size={16} /> },
    { id: 'safety', name: 'Safety / APD', icon: <ShieldAlert size={16} /> },
    { id: 'furniture', name: 'Mebel Kantor', icon: <Armchair size={16} /> },
  ];
  ...
  const productList = [
    ...
    },
    {
      id: 'safety-2',
      category: 'safety',
      name: 'Sepatu & Sarung Tangan Lapangan',
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pb-4">
            {categories.map((cat) => (
              <button
                ...
                className={`flex items-center gap-2 py-2.5 px-5 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300 border cursor-pointer ${
            ...
            >
              <div className="bg-white rounded-2xl overflow-hidden border border-slate-200/85 shadow-sm hover:shadow-2xl hover:border-brand-blue/30 transition-all duration-300 flex flex-col group h-full w-full grad-border-card">
                ...
                <div className="relative aspect-[16/10] overflow-hidden bg-slate-100">
                  ...
                  <span className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm border border-slate-150 py-1 px-3 rounded-full text-[10px] font-bold text-brand-blue uppercase tracking-wider shadow-sm">
                ...
                <div className="p-6 flex flex-col justify-between flex-grow text-left">
                  ...
                  <div className="pt-6 mt-auto">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-slate-100 hover:bg-brand-blue hover:text-white text-slate-700 font-semibold py-2.5 px-4 rounded-xl transition-all duration-300 text-xs border border-slate-200 group-hover:border-transparent cursor-pointer"
                    >
